...
$string['importcourses_help'] = 'Courses that already exist (matched by id number or short name) are reused. Missing courses are restored from the .mbz files inside the zip. Restoring many large courses can take a long time.';
