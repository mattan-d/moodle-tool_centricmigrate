...
$string['importcourses_help'] = 'קורסים שכבר קיימים (לפי מספר מזהה או שם מקוצר) ישויכו מחדש. קורסים חסרים ישוחזרו מקבצי .mbz בתוך ה-zip. שחזור קורסים גדולים עלול לקחת זמן רב.';
